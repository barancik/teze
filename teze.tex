...
On~the other hand, Czech \textbf{Meteor Paraphrase tables} are quite the opposite of Czech WordNet -- 
...
paraphrases in the Meteor table in the following way. %, the method are described in \Sref{filtering-section}.
...
paraphrasing of reference sentences %(see the column \textbf{Basic} in \Tref{results:12:13})
...
the box and the best scores are in bold. % \xxx{podle lopatkovy preformulovat}
